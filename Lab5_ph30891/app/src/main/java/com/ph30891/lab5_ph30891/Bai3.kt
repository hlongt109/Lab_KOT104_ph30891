...
fun CategoryApp(){
    ...
    Column(
        ...
        CategoryChips(categories = categories, selectedCategories = selectedCategories, onCategorySelected = {category ->
        ...
        SuggestionChips(suggesttions = suggestions, selectedCategories = selectedCategories, onCategorySelected = {suggestion ->
        ...
        if(selectedCategories.isNotEmpty()){
            ...
            AssistChip(
                ...
                label = {
                    Text(
                        text = "Clear selections", style = TextStyle(color = Color.White, fontWeight = FontWeight.Bold
                        )
                    )
                },
