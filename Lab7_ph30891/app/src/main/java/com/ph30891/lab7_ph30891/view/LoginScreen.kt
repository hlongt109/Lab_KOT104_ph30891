...
import com.ph30891.lab7_ph30891.R
import com.ph30891.lab7_ph30891.utils.ScreenList
import com.ph30891.lab7_ph30891.viewModel.LoginViewModel
...
fun HandleLoginState(
    ...
    val isAuthenticator by loginViewModel.isAuthenticated.observeAsState()
    LaunchedEffect(key1 = isAuthenticator) {
        when(isAuthenticator){
            true -> {
                navController.navigate(ScreenList.MVCREEN.route){
                    popUpTo(ScreenList.MVCREEN.route){inclusive = true}
                }
            }
            false ->{
